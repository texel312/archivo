...
#////////// BLOQUE INICIALIZACION Y CICLO DE CONSULTA DE ESTADO DEL SISTEMA////////////////////////////////////////
   ...
   def inicializar(self):
       ...
       self.ui.label6.setStyleSheet("background-image: url(cabezal1_activ.png);")
       self.ui.label7.setStyleSheet("background-image: url(cabezal2_desac.png);")
       self.ui.label8.setStyleSheet("background-image: url(cabezal4_desac.png);")
       self.ui.label9.setStyleSheet("background-image: url(:cabezal3_desac.png);")
       self.pedirestado()
...
# tiempo de sesion
   ...
   def mousePressEvent(self, event):
       ...
       if self.posxy2[0] < 1280 and self.posxy2[0] > 0 and self.posxy2[1] < 800 and self.posxy2[1] > 0:
           ...
           self.ui.stackedWidget.setStyleSheet("background-image: url(Pantalla Grande8.png);")
           self.bloquearpag0 = 1
           self.bloquearpag1 = 0
