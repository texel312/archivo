...
class MyForm(QDialog):
   def __init__(self):
       ...
       self.ui.cancelar.clicked.connect(lambda: self.ui.texto_iniciar.setText("iniciar"))
       self.ui.cancelar_2.clicked.connect(lambda: self.animarlabel4(self.ui.cancelar_2, 20, 24, 3))
       self.ui.cancelar_2.clicked.connect(lambda: self.ui.texto_iniciar.setText("iniciar"))
